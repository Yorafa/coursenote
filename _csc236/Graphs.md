...
-   A $k$**-(vertex) coloring** of $G$ is a function $f: V\to C$ , $\forall u,v \in V, \{u,v\}\in E \or \{v,u\}\in E \implies f(u) \ne f(v)$
-   **Connected**: $\forall u,v \in V,  v\ne u, $ there is some path from $u$ to $v$
-   **acyclic**: no cycle in graph
-   **independent set**: $I \subseteq V$ , $\forall v,u\in I, \cancel{\exist} e\in E, e = \{v,u\}\or e=\{u,v\} \implies I$ is an independent set 
