...
-   $A\subseteq \bigcup_{n\in \N}A_n\implies \mu(A) \le \sum_{n\in\N}\mu(A_n)$
...
-   From this, we can conclude, $\forall B_i, i\ge 1, \bigcup_{i = 1} B_i = B \implies P(A) = P(A\cap B)  = \sum_{i = 1} P(A|B_i)P(B_i)$
