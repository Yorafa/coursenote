...
Let $A, A_1, A_2, \ldots\in \wp(\mathbb{X})$. $A_1\subseteq A_2\subseteq\ldots$ and $\bigcup_{n\in\N}A_n = A\iff$ the sequence $(A_n)_{n\in \N}$ **increases** to $A$.
...
-   $\lim\sup_{n\to \infty} A_n := \cap_{n\in \N}\bigcup_{k\ge n} A_k$ and $\lim\inf_{n\to \infty} A_n := \bigcup_{n\in \N}\cap_{k\ge n} A_k$
-   Since $\forall l,n\in \N, \cap_{k\ge l}A_k \subseteq \bigcup_{k\ge n} A_k$, then $\lim\inf_{n\to \infty} A_n \subset\lim\sup_{n\to \infty} A_n$
