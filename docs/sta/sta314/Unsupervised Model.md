...
- Common to use Euclidean distance as the measure of difference, $W(C_k) = \frac{1}{|C_k|} \sum_{i,i' \in C_k}\sum_{j = 1}^p (x_{ij}x_{i'j})^2$ where $|C_k|$ is the number of observations in cluster $C_k$.
