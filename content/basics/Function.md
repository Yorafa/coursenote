...
**Cardinality**: Let $F = \{f| f: A\to B\}$. $\exist f\in F, f$ is bijective $\implies$ $A$ and $B$ have the same cardinality. Normally, we use cardinality to describe the size of a collection.
