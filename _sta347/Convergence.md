...
Let $X_1, X_2,\ldots$ be a sequence of random variables. Let $X$ be another random variable.  the sequence $\{X_n\}$ is **almost surely** to $X$ if $P(\{s: X_n(s) \to X(s) \}) = 1$. We denote it as $X_n \overset{\text{a.s.}}\to X$.
...
-   $X_n \overset{P}\to X$ and $Y_n \overset{P}\to Y \implies X_n + Y_n \overset{P}\to X + Y$
-   $X_n \overset{P}\to X$ and $Y_n \overset{P}\to Y \implies X_nY_n \overset{P}\to X Y$
